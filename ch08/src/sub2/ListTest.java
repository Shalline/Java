...
public class ListTest {
	...
	public static void main(String[] args) {
		...
		// ArrayList 기본, int, float 등 기본타입취급안함 레퍼써야됨
		...
		list.add(4);
		list.add(5);
		list.add(1,6); // 인덱스1에 6을 삽입
		
		System.out.println(list);
		
		// 데이터 제거
		list.remove(2); // 인덱스번호 2
		System.out.println(list);
		
		list.remove(3); // 인덱스번호 3내용 삭제
		System.out.println(list);
		...
		// 데이터 반복
		// Integer를 int로 받는다. 즉, Auto unboxing이 일어나는것
		for(int num : list) {
